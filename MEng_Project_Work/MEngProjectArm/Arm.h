...
struct Arm {
	...
	void updateServoPosition(uint8_t id, int position);
	void updateServoPosition(uint8_t id, uint8_t position_L, uint8_t position_H);
	void updateServoPosition_rad(uint8_t id, int position_rad);
	void updateServoPosition_deg(uint8_t id, int position_deg);
	...
	void moveSpeed(uint8_t id, uint16_t Position, uint16_t Speed);
	void moveSpeedEasy(uint8_t id, int PositionDeg, float SpeedPer);
	void move(uint8_t id, int Position); 
	void turn(uint8_t id, bool side, int Speed);
	int checkPosition(uint8_t id, uint16_t Position);
